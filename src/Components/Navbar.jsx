...
const Navbar = () => {
  ...
  return (
   ...
   {nav ? <div className='bg-black/80 w-full h-screen z-10 fixed top-0 left-0'></div> : ''}
      

      {/* Side Bar */}
      <div className={nav ? 'bg-white fixed top-0 left-0 h-screen z-10 w-[250px] duration-300' : 
      'bg-white fixed top-0 left-[-100%] h-screen z-10 w-[250px] duration-300'}>
